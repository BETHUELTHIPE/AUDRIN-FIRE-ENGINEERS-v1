...
import { Mic, ShieldAlert, FileCode } from 'lucide-react';
...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-slate-100 flex flex-col selection:bg-[#C1A461] selection:text-black font-sans antialiased">
      ...
      {/* Main View Router */}
      <main className="flex-grow bg-[#0A0A0B]">
        {currentView === 'home' && (
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-2.5 items-end">
        ...
        {!voiceGuideOpen && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#C1A461] to-[#A88B46] hover:from-[#D4BC7B] hover:to-[#C1A461] text-black rounded-full shadow-2xl shadow-black/60 text-xs font-bold tracking-wide transition-all duration-300 hover:scale-105 border border-white/10"
          >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 bg-[#151518]/90 hover:bg-[#1E1E22] text-white/70 hover:text-white rounded-full border border-white/10 shadow-xl text-xs font-mono transition"
